...
const resources = {
  es: {
    translation: {
      ...
      'hero.subtitle': 'Backend & Data Developer (Junior)',
      'hero.description': 'Desarrollo aplicaciones, automatizaciones y soluciones de gestión de datos orientadas a negocio.',
      'hero.cta': 'Ver Proyectos',
      
      // Sobre Mí
      'about.title': 'Sobre Mí',
      'about.description': 'Conoce un poco más sobre mí, mi experiencia y mi pasión por el desarrollo web.',
      'about.parrafo1': 'Soy desarrollador junior orientado a backend, datos y automatización, con experiencia en el desarrollo de aplicaciones internas, gestión de datos y mejora de procesos. He trabajado con SAP para la gestión de información, Tableau para la creación de paneles de control y visualización de datos, y con Ruby on Rails y Django para desarrollar herramientas internas orientadas a negocio. También he creado automatizaciones con Power Automate para optimizar tareas y flujos de trabajo.',
      'about.parrafo2': 'Además, cuento con experiencia previa en desarrollo web, lo que me ha permitido construir una base sólida en diseño y desarrollo de aplicaciones, adaptarme a distintos entornos tecnológicos y tener una visión más completa del ciclo de desarrollo.',
      'about.parrafo3': 'Me interesa seguir creciendo en proyectos donde pueda combinar desarrollo backend, datos y automatización para crear soluciones útiles, mantenibles y con impacto real en los equipos y procesos.',
