...
const resources = {
  es: {
    translation: {
      ...
      'hero.subtitle': 'Backend & Data Developer (Junior) en Tecnobit - Grupo Oesía',
      'hero.description': 'Especializado en gestión de datos con SAP y Tableau. Desarrollo de aplicaciones backend con Django y Ruby on Rails. Transformando datos en soluciones empresariales.',
      'hero.cta': 'Ver Proyectos',
      
      // Sobre Mí
      'about.title': 'Sobre Mí',
      'about.description': 'Conoce mi carrera como Backend & Data Developer en Tecnobit - Grupo Oesía, especializado en gestión de datos y desarrollo de aplicaciones.',
      'about.parrafo1': 'Desde junio de 2025, trabajo como Backend & Data Developer Junior en Tecnobit - Grupo Oesía, una empresa líder en soluciones tecnológicas y ciberseguridad. Durante mi beca, he adquirido experiencia práctica en desarrollo backend y gestión empresarial de datos, combinando formación académica con responsabilidades reales en un entorno profesional.',
      'about.parrafo2': 'Mi especialización se centra en el ecosistema de datos y desarrollo backend. Trabajo con SAP para la gestión integral de datos empresariales, Tableau para la visualización y análisis de datos, Ruby on Rails para aplicaciones internas de gestión de datos (desarrollado como Trabajo de Fin de Grado), y Django con Vanilla JS y Tailwind CSS para herramientas internas. Mi objetivo es transformar datos complejos en soluciones prácticas y eficientes.',
      'about.parrafo3': 'Además de mi trabajo en la empresa, tengo el privilegio de representar a Tecnobit en institutos y centros formativos, compartiendo experiencias sobre Formación Profesional y las oportunidades en el sector tecnológico. Creo en el poder de la educación técnica y en el potencial de los jóvenes profesionales para innovar en el campo de la tecnología.',
      'about.experience': 'Años de Experiencia',
      'about.projects': 'Proyectos Completados',
      'about.clients': 'Clientes Satisfechos',
      'about.cumpleanos': 'Cumpleaños',
      'about.direccion': 'Dirección',
      'about.cargo': 'Backend & Data Developer (Junior) - Tecnobit',
      ...
      'projects.items.mejorAppT.description': 'Aplicación Android desarrollada con .NET MAUI en colaboración con la Facultad de Psicología de la Universidad de Valencia. La aplicación está orientada a la realización de tests sobre conducta alimentaria y, a partir de los resultados obtenidos, la edad y otros factores relevantes, genera recomendaciones personalizadas adaptadas a cada usuario.',
      'projects.items.mejorAppT.detailedDescription': 'Mi contribución se centró en la implementación del sistema de almacenamiento de datos, garantizando que la información quedara registrada tanto en la memoria local del dispositivo como en la nube mediante Firebase. Además, diseñé un mecanismo de sincronización automática que actualiza los datos locales con la nube en cuanto el dispositivo detecta conexión a internet, asegurando la integridad, disponibilidad y consistencia de la información.',
      ...
      'projects.items.proyectoMia.description': 'Chat con IA diseñado para explicar contenidos del ciclo de formación profesional de DAM.',
      'projects.items.proyectoMia.detailedDescription': 'Desarrollo de una aplicación de escritorio en WPF, basada en el patrón MVVM, con un diseño moderno, animaciones fluidas y una arquitectura limpia y mantenible. Además, incorpora Llama 3.2 como modelo de IA, Vosk API para el reconocimiento de voz y System.Speech para la síntesis de voz, permitiendo una interacción más natural con el avatar.',
      ...
      'footer.description': ' Backend & Data Developer (Junior) | SAP · Tableau · Django · Ruby on Rails · Power Automate'
    }
  },
  en: {
    translation: {
      ...
      'hero.title': 'Diego Moreno',
      'hero.subtitle': 'Backend & Data Developer (Junior) at Tecnobit - Grupo Oesía',
      'hero.description': 'Specialized in data management with SAP and Tableau. Backend application development with Django and Ruby on Rails. Transforming data into enterprise solutions.',
      'hero.cta': 'View Projects',
      
      // About
      'about.title': 'About Me',
      'about.description': 'Learn about my career as a Backend & Data Developer at Tecnobit - Grupo Oesía, specialized in data management and application development.',
      'about.parrafo1': 'Since June 2025, I work as a Junior Backend & Data Developer at Tecnobit - Grupo Oesía, a leading company in technological solutions and cybersecurity. During my internship, I have gained practical experience in backend development and enterprise data management, combining academic training with real responsibilities in a professional environment.',
      'about.parrafo2': 'My specialization centers on the data and backend development ecosystem. I work with SAP for comprehensive enterprise data management, Tableau for data visualization and analytics, Ruby on Rails for internal data management applications (developed as my Final Degree Project), and Django with Vanilla JS and Tailwind CSS for internal tools. My goal is to transform complex data into practical and efficient solutions.',
      'about.parrafo3': 'Beyond my work at the company, I have the privilege of representing Tecnobit at institutes and training centers, sharing experiences about Vocational Training and opportunities in the technology sector. I believe in the power of technical education and the potential of young professionals to innovate in the field of technology.', 
